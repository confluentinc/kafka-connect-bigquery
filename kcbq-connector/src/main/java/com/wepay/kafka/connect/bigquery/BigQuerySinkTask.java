...
public class BigQuerySinkTask extends SinkTask {
  ...
  private SchemaManager newSchemaManager() {
    ...
    boolean useDestinationTableSchemaForIntermediateTableSchema = config.getBoolean(BigQuerySinkConfig.USE_DESTINATION_TABLE_SCHEMA_FOR_INTERMEDIATE_TABLE_SCHEMA_CONFIG);
